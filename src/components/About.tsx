...
export default function About({ }: Props) {
    ...
    return (
        <motion.section
            ...
            id="about"
            className="snap-center min-h-screen text-center max-w-7xl mx-[10%] flex flex-col"
        >
            <h3 className="uppercase tracking-[20px] text-gray-500 text-2xl mt-20 mb-12">About me</h3>
